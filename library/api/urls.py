...
urlpatterns = [
    ...
    path('edit-resource-section/<int:resource_section_id>/', views.edit_resource_section, name='edit_resource_section'),
    path('delete-resource-section/<int:resource_section_id>/', views.delete_resource_section, name='delete_resource_section'),
