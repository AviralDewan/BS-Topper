...
urlpatterns = [
    ...
    path('add-resource_section/<int:resource_id>', views.add_resource_section, name='add_resource_section'),
    ...
    path('get-sections/<int:resource_id>', views.get_sections, name='get_sections')
]